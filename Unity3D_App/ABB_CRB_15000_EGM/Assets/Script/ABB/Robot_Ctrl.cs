...
public class Robot_Ctrl : MonoBehaviour
{
    ...
    void OnApplicationQuit()
    {
        try
        {
            // Start Control Robot {ABB Externally Guided Motion - EGM}
    ...
    class Egm_Control
    {
        ...
        void EMG_Sensor_Message(EgmSensor.Builder egm_s)
        {
            ...
            orientation.SetX(ABB_EGM_Control.C_Orientation[0] + 180.0)
                       .SetY(ABB_EGM_Control.C_Orientation[1] + 0.0)
                       .SetZ(ABB_EGM_Control.C_Orientation[2] + 180.0);
