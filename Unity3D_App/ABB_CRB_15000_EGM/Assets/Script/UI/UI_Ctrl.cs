...
public class UI_Ctrl : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        // Cycli read-write parameters to the robot
        ...
        ABB_EGM_Control.C_Orientation[0] = Math.Round(C_Orientation[0].value, 0);
        ABB_EGM_Control.C_Orientation[1] = Math.Round(C_Orientation[1].value, 0);
        ABB_EGM_Control.C_Orientation[2] = Math.Round(C_Orientation[2].value, 0);
